...
public class NotificationServiceLocator extends org.apache.axis.client.Service implements NotificationService
{
 ...
 */
    ...
    public NotificationPort getNotification() throws javax.xml.rpc.ServiceException {
    ...
    public NotificationPort getNotification(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            NotificationBindingStub _stub = new NotificationBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (NotificationPort.class.isAssignableFrom(serviceEndpointInterface)) {
                NotificationBindingStub _stub = new NotificationBindingStub(new java.net.URL(Notification_address), this);
                _stub.setPortName(getNotificationWSDDServiceName());
                return _stub;
            }
        }
