...
public class ObjectFactory {
    ...
    private final static QName _NotificationMessageCSalesforceIdC_QNAME = new QName("urn:sobject.enterprise.soap.sforce.com", "SalesforceId__c");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sobject.enterprise.soap.sforce.com", name = "SalesforceId__c", scope = NotificationMessageC.class)
    public JAXBElement<String> createNotificationMessageCSalesforceIdC(String value) {
        return new JAXBElement<String>(_NotificationMessageCSalesforceIdC_QNAME, String.class, NotificationMessageC.class, value);
    }
